...
const Lines = () => {
  return(
    <g>
      <path d="M25 0 V 120" stroke="black"></path>
      <path d="M135 0 V 160" stroke="black"></path>
      <path d="M265 0 V 160" stroke="black"></path>
      <path d="M375 0 V 120" stroke="black"></path>
...
const LeftConner = (props) => {
  ...
  return(
    <path d="M0 0 V 120 H 25 V 0 H 0" fill={color} onClick={handleClick}></path>
  );
}
const LeftShortConner = (props) => {
  ...
  return(
    <path d="M25 0 V 120 H 135 V 0 H 25" fill={color} onClick={handleClick}></path>
  );
}
const PaintZone = (props) => {
  ...
  return(
    <path d="M135 0 V 160 H 265 V 0 H 135" fill={color} onClick={handleClick}></path>
  );
}
const RightShortConner = (props) => {
  ...
  return(
    <path d="M265 0 V 120 H 375 V 0 H 265" fill={color} onClick={handleClick}></path>
  );
}
const RightConner = (props) => {
  ...
  return(
    <path d="M375 0 V 120 H 400 V 0 H 375" fill={color} onClick={handleClick}></path>
  );
}
const LeftElbow = (props) => {
  ...
  return(
    <path d="M25 120 C 50 200 110 220 135 230 V 120 Z " fill={color} onClick={handleClick}></path>
  );
}
const Key = (props) => {
  const {onClick, index, color} = props;
  ...
  return(
    <path d="M135 230 C 170 242 230 242 265 230 V 160 H 135 Z" fill={color} onClick={handleClick}></path>
  );
}
const RightElbow = (props) => {
  ...
  return(
    <path d="M375 120 C 345 200 285 220 265 230 V 120 Z " fill={color} onClick={handleClick}></path>
  );
}
const LeftWing = (props) => {
  ...
  return(
    <path d="M0 120 H 25 C 50 200 110 217 105 216 L 85 280 H 0 Z" fill={color} onClick={handleClick}></path>
  );
}
const RightWing = (props) => {
  ...
  return(
    <path d="M400 120 H 375 C 345 200 285 218 295 217 L 315 280 H 400 Z" fill={color} onClick={handleClick}></path>
  );
}
const Top = (props) => {
  const {onClick, index, color} = props;
  ...
  return(
    <path d="M105 216 L 85 280 H 315 L 295 216 C 240 245 155 248 105 216" fill={color} onClick={handleClick}></path>
  );
}
